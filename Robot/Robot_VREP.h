...
class Robot_VREP: public Robot
{
    ...
    virtual bool setPositionControl();
    virtual bool setVelocityControl();
    
    bool getCollision();

    
    Coord getCOMOrientation();
    double getCOMVelocity();
    
    Coord getCOMPosition();
